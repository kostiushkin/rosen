...
%
% $Id: eurobot.erl,v 1.14 2008/11/16 20:34:57 corrado_santoro Exp $
%
-module (eurobot).
-export ([go/0, create_robot/0, sensors_and_motion/0]).
...
%  rosen:start_link(?ROSEN_OPTIONS),
  ...
  robot:command (robot1, {set_position, 0.0, -?CM(105) + ?CM(6), 100.0}),
